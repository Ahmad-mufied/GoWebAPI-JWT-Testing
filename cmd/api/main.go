...
func main() {
	...
	flag.StringVar(&app.JWTSecret, "jwt-secret", "\n\neyJhbGciOiJIUzI1NiJ9.eyJSb2xlIjoiQWRtaW4iLCJJc3N1ZXIiOiJJc3N1ZXIiLCJVc2VybmFtZSI6IkphdmFJblVzZSIsImV4cCI6MTY5NjEzMzc1NywiaWF0IjoxNjk2MTMzNzU3fQ.kVSyCE6TeFo8TFLGhBStBLzKpwPh75lr97EisMWHEEU", "signing secret")
	flag.Parse()
